...
Public Class PaymentMethodMainForm
    Dim query1 As String = "SELECT * from payroll_PaymentMethod "
    Dim query2 As String = " PaymentMethod"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim PayMethodID As Integer = reader.Item("PayMethodID")
                    Dim PaymentMethod As String = reader.Item("PaymentMethod")
                    Dim x As New PaymentMethodRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(PayMethodID)
                        .PayMethodID = PayMethodID
                        .Text = "Currently modifying : " & PaymentMethod
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from payroll_PaymentMethod WHERE PayMethodID='" & Me.DataGridView1.Item(i, "PayMethodID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "PayMethodID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from payroll_PaymentMethod WHERE PayMethodID='" & Me.DataGridView1.Item(i, "PayMethodID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingPaymentMethods(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingPaymentMethods(overallQuery)
    End Sub
    Public Sub loadingPaymentMethods(ByVal sql As String)
        Try
    ...
    Public Sub formatdatagrid()
        ...
        With Me.DataGridView1
            ...
            .Item(0, 1) = "ID"
            .Cols("PayMethodiD").Visible = False
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(PaymentMethod.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingPaymentMethods(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from payroll_PaymentMethod WHERE"
        Classification = "  PaymentMethod LIKE '%" & convertQuotes(Me.PaymentMethod.Text) & "%'"
