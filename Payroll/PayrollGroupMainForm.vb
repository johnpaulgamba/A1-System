...
Public Class PayrollGroupMainForm
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from Payroll_Group WHERE PayGroupID='" & Me.DataGridView1.Item(i, "PayGroupID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "PayGroupID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from Payroll_Group WHERE PayGroupID='" & Me.DataGridView1.Item(i, "PayGroupID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingPayrollGroups(overallQuery)
    End Sub
    Public Sub loadingPayrollGroups(ByVal sql As String)
        Try
    ...
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from Payroll_Group WHERE"
        Classification = "  PayrollGroup LIKE '%" & convertQuotes(Me.PayrollGroup.Text) & "%'"
