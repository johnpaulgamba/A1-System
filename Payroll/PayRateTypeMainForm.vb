...
Public Class PayRateTypeMainForm
    Dim query1 As String = "SELECT * from Payroll_PayRateType "
    Dim query2 As String = " PayRateType"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim PayRateID As Integer = reader.Item("PayRateID")
                    Dim PayRateType As String = reader.Item("PayRateType")
                    Dim x As New PayRateTypeRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(PayRateID)
                        .PayRateID = PayRateID
                        .Text = "Currently modifying : " & PayRateType
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from Payroll_PayRateType WHERE PayRateID='" & Me.DataGridView1.Item(i, "PayRateID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "PayRateID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from Payroll_PayRateType WHERE PayRateID='" & Me.DataGridView1.Item(i, "PayRateID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingPayRateTypes(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingPayRateTypes(overallQuery)
    End Sub
    Public Sub loadingPayRateTypes(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(PayRateType.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingPayRateTypes(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from Payroll_PayRateType WHERE"
        Classification = "  PayRateType LIKE '%" & convertQuotes(Me.PayRateType.Text) & "%'"
