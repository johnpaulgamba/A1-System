...
Public Class Payroll_13MonthPay
...
#End Region
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        Dim filtersearchquery As String = payrolldatequery & s1 & s2 & s4 & " and s.payrollgroup='" & PayrollGroup.Text & "'"

        loadingPayrollGroups("Reporting_PayrollRegister_13thMonthPay", filtersearchquery, payrolldatequery)
