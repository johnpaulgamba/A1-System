...
Public Class Payroll_Register_SemiMonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Payroll_Register_SemiMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Payroll_Register_SemiMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_payrollids() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPayroll_Register_SemiMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Payroll_Register_SemiMonthly = New Payroll_Register_SemiMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
