...
Public Class PaySlip_Weekly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.PaySlip_Weekly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaySlip_Weekly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaySlip_Weekly = New PaySlip_Weekly()
        rpt.Site = Me.Site
        Return rpt
    End Function
