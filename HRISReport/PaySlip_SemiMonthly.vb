...
Public Class PaySlip_SemiMonthly
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PaySlip_SemiMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.PaySlip_SemiMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaySlip_SemiMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaySlip_SemiMonthly = New PaySlip_SemiMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
