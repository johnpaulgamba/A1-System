...
Public Class Payroll_Voucher
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Payroll_Voucher.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayroll_Voucher
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Payroll_Voucher = New Payroll_Voucher()
        rpt.Site = Me.Site
        Return rpt
    End Function
