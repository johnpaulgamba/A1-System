...
Public Class EmployeeProfile201
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.EmployeeProfile201.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmployeeProfile201
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EmployeeProfile201 = New EmployeeProfile201()
        rpt.Site = Me.Site
        Return rpt
    End Function
