...
Public Class SalesinvoiceByItems
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SalesinvoiceByItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.SalesinvoiceByItems.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSalesinvoiceByItems
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SalesinvoiceByItems = New SalesinvoiceByItems()
        rpt.Site = Me.Site
        Return rpt
    End Function
