...
Public Class HeadCountPerLocation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HeadCountPerLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.HeadCountPerLocation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHeadCountPerLocation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HeadCountPerLocation = New HeadCountPerLocation()
        rpt.Site = Me.Site
        Return rpt
    End Function
