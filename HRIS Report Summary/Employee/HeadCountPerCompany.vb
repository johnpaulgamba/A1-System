...
Public Class HeadCountPerCompany
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "HeadCountPerCompany.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.HeadCountPerCompany.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHeadCountPerCompany
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HeadCountPerCompany = New HeadCountPerCompany()
        rpt.Site = Me.Site
        Return rpt
    End Function
