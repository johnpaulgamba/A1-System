...
Public Class HeadCountReport
    ...
    Public Sub printReports(ByVal a As String, ByVal groupby As String, ByVal b As String, ByVal c As Integer)
        ...
        Try
            ...
            With command
                ...
                .CommandText = a
                .Parameters.AddWithValue("@groupbys", groupby)
            ...
            Else
                If c = 1 Then
                    Dim crpt As New HeadCountPerCompany
                    With crpt
                    ...
                    End With
                ElseIf c = 2 Then
                    Dim crpt As New HeadCountPerDepartment
                    With crpt
                        .SetDataSource(ds.Tables(0))
                        Me.CrystalReportViewer2.ReportSource = crpt
                        Me.CrystalReportViewer2.Refresh()
                    End With
                ElseIf c = 3 Then
                    Dim crpt As New HeadCountPerLocation
                    With crpt
                        .SetDataSource(ds.Tables(0))
                        Me.CrystalReportViewer2.ReportSource = crpt
                        Me.CrystalReportViewer2.Refresh()
                    End With
                ElseIf c = 4 Then
                    Dim crpt As New HeadCountPerPosition
                    With crpt
                        .SetDataSource(ds.Tables(0))
                        Me.CrystalReportViewer2.ReportSource = crpt
                        Me.CrystalReportViewer2.Refresh()
    ...
    Private Sub cmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPrint.Click
        Try
            ...
            If rdoCompany.Checked = True Then
                With Me
                    .printReports("Reporting_Employee_Summary", " COMPANYNAME ", filtersearchquery, 1)
                End With
            ElseIf Me.rdodepartment.Checked = True Then
                With Me
                    .printReports("Reporting_Employee_Summary", " DEPARTMENT ", filtersearchquery, 2)
                End With
            ElseIf Me.rdolocation.Checked = True Then
                With Me
                    .printReports("Reporting_Employee_Summary", " LOCATION ", filtersearchquery, 3)
                End With
            ElseIf Me.rdoposition.Checked = True Then
                With Me
                    .printReports("Reporting_Employee_Summary", " POSITION ", filtersearchquery, 4)
                End With
