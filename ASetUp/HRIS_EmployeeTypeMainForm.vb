...
Public Class HRIS_EmployeeTypeMainForm
    Dim query1 As String = "SELECT * from hris_EmployeeType "
    Dim query2 As String = " EmployeeType"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim EmployeeTypeID As Integer = reader.Item("EmployeeTypeID")
                    Dim EmployeeType As String = reader.Item("EmployeeType")
                    Dim x As New HRIS_EmployeeTypeRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(EmployeeTypeID)
                        .EmployeeTypeID = EmployeeTypeID
                        .Text = "Currently modifying : " & EmployeeType
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_EmployeeType WHERE EmployeeTypeID='" & Me.DataGridView1.Item(i, "EmployeeTypeID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "EmployeeTypeID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_EmployeeType WHERE EmployeeTypeID='" & Me.DataGridView1.Item(i, "EmployeeTypeID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingEmployeeTypes(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingEmployeeTypes(overallQuery)
    End Sub
    Public Sub loadingEmployeeTypes(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(EmployeeType.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingEmployeeTypes(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_EmployeeType WHERE"
        Classification = "  EmployeeType LIKE '%" & convertQuotes(Me.EmployeeType.Text) & "%'"
