...
Public Class HDMFTABLEMainForm
    Dim query1 As String = "SELECT HDMFID as HDMF_ID, format(RangeFrom,3)as Range_From, format(RangeTo,3) as Range_To,  format(HDMFEE,3) as EE_Share,format(HDMFER,3) as ER_Share, Compute, Creator  from HDMFTABLE "
    Dim query2 As String = " HDMFID"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim HDMFID As Integer = reader.Item("HDMFID")
                    'Dim HDMFTABLE As String = reader.Item("HDMFTABLE")
                    'Dim x As New HDMFTABLERegistration
                    ' With x
                    '.QuerytoString = overallQuery
                    ' .toSave = False
                    '.EditLoad(HDMFID)
                    ' .HDMFID = HDMFID
                    ' .Text = "Currently modifying : " & HDMFTABLE
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_HDMFTABLE WHERE HDMFID='" & Me.DataGridView1.Item(i, "HDMFID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "HDMFID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_HDMFTABLE WHERE HDMFID='" & Me.DataGridView1.Item(i, "HDMFID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingHDMFTABLEs(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingHDMFTABLEs(overallQuery)
    End Sub
    Public Sub loadingHDMFTABLEs(ByVal sql As String)
        Try
    ...
    Public Sub formatdatagrid()
        ...
        With Me.DataGridView1
            ...
            ' .Item(0, 1) = "ID"
            .Cols("HDMF_ID").TextAlign = TextAlignEnum.RightCenter
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(HDMFTABLE.Text, Creator.Text, Description.Text, ChangesMade.Text, DateCreated.Text, LastUpdate.Text, OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingHDMFTABLEs(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from HDMFTABLE WHERE"
        Classification = "  "
        creator = "  "
        description = " "
        changesmade = " "
