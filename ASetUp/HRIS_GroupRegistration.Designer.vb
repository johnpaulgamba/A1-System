...
Partial Class HRIS_GroupRegistration
    ...
    Private Sub InitializeComponent()
        ...
        Me.C1InputPanel6.Items.Add(Me.GroupName)
        ...
        Me.InputLabel2.Text = "Add / Modify Existing Group"
        '
        'InputGroupHeader1
        '
