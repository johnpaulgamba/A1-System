...
Public Class HRIS_PositionMainForm
    Dim query1 As String = "SELECT * from hris_Position "
    Dim query2 As String = " PositionName"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim PositionID As Integer = reader.Item("PositionID")
                    Dim Position As String = reader.Item("PositionName")
                    Dim x As New HRIS_PositionRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(PositionID)
                        .PositionID = PositionID
                        .Text = "Currently modifying : " & Position
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_Position WHERE PositionID='" & Me.DataGridView1.Item(i, "PositionID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "PositionID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_Position WHERE PositionID='" & Me.DataGridView1.Item(i, "PositionID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingPositions(overallQuery)
    End Sub
    Public Sub loadingPositions(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(Position.Text, Creator.Text, Description.Text, OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingPositions(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_Position WHERE"
        Classification = "  PositionName LIKE '%" & convertQuotes(Me.Position.Text) & "%'"
