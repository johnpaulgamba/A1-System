...
Public Class HRIS_EmploymentLevelMainForm
    Dim query1 As String = "SELECT * from hris_EmploymentLevel "
    Dim query2 As String = " EmploymentLevel"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim EmploymentLevelID As Integer = reader.Item("EmploymentLevelID")
                    Dim EmploymentLevel As String = reader.Item("EmploymentLevel")
                    Dim x As New HRIS_EmploymentLevelRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(EmploymentLevelID)
                        .EmploymentLevelID = EmploymentLevelID
                        .Text = "Currently modifying : " & EmploymentLevel
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_EmploymentLevel WHERE EmploymentLevelID='" & Me.DataGridView1.Item(i, "EmploymentLevelID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "EmploymentLevelID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_EmploymentLevel WHERE EmploymentLevelID='" & Me.DataGridView1.Item(i, "EmploymentLevelID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingEmploymentLevels(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingEmploymentLevels(overallQuery)
    End Sub
    Public Sub loadingEmploymentLevels(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(EmploymentLevel.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingEmploymentLevels(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_EmploymentLevel WHERE"
        Classification = "  EmploymentLevel LIKE '%" & convertQuotes(Me.EmploymentLevel.Text) & "%'"
    ...
    Private Sub ClearFields_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClearFields.Click
        Me.EmploymentLevel.Text = Nothing
