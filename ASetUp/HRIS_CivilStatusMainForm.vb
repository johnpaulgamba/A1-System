...
Public Class HRIS_CivilStatusMainForm
    Dim query1 As String = "SELECT * from hris_CivilStatus "
    Dim query2 As String = " CivilStatus"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim CivilStatusID As Integer = reader.Item("CivilStatusID")
                    Dim CivilStatus As String = reader.Item("CivilStatus")
                    Dim x As New HRIS_CivilStatusRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(CivilStatusID)
                        .CivilStatusID = CivilStatusID
                        .Text = "Currently modifying : " & CivilStatus
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_CivilStatus WHERE CivilStatusID='" & Me.DataGridView1.Item(i, "CivilStatusID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "CivilStatusID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_CivilStatus WHERE CivilStatusID='" & Me.DataGridView1.Item(i, "CivilStatusID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingCivilStatuss(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingCivilStatuss(overallQuery)
    End Sub
    Public Sub loadingCivilStatuss(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(CivilStatus.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingCivilStatuss(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_CivilStatus WHERE"
        Classification = "  CivilStatus LIKE '%" & convertQuotes(Me.CivilStatus.Text) & "%'"
