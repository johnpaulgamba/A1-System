...
Public Class hris_EmploymentStatusMainForm
    Dim query1 As String = "SELECT * from hris_EmploymentStatus "
    Dim query2 As String = " EmploymentStatus"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim EmploymentStatusID As Integer = reader.Item("EmploymentStatusID")
                    Dim EmploymentStatus As String = reader.Item("EmploymentStatus")
                    Dim x As New hris_EmploymentStatusRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(EmploymentStatusID)
                        .EmploymentStatusID = EmploymentStatusID
                        .Text = "Currently modifying : " & EmploymentStatus
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_EmploymentStatus WHERE EmploymentStatusID='" & Me.DataGridView1.Item(i, "EmploymentStatusID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "EmploymentStatusID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_EmploymentStatus WHERE EmploymentStatusID='" & Me.DataGridView1.Item(i, "EmploymentStatusID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click
        loadingEmploymentStatuss(overallQuery)
    End Sub
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingEmploymentStatuss(overallQuery)
    End Sub
    Public Sub loadingEmploymentStatuss(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(EmploymentStatus.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingEmploymentStatuss(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_EmploymentStatus WHERE"
        Classification = "  EmploymentStatus LIKE '%" & convertQuotes(Me.EmploymentStatus.Text) & "%'"
    ...
    Private Sub ClearFields_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClearFields.Click
        Me.EmploymentStatus.Text = Nothing
