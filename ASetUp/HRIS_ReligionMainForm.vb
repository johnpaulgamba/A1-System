...
Public Class HRIS_ReligionMainForm
    Dim query1 As String = "SELECT * from hris_Religion "
    Dim query2 As String = " Religion"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim ReligionID As Integer = reader.Item("ReligionID")
                    Dim Religion As String = reader.Item("Religion")
                    Dim x As New HRIS_ReligionRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(ReligionID)
                        .ReligionID = ReligionID
                        .Text = "Currently modifying : " & Religion
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_Religion WHERE ReligionID='" & Me.DataGridView1.Item(i, "ReligionID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "ReligionID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_Religion WHERE ReligionID='" & Me.DataGridView1.Item(i, "ReligionID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
...
#End Region
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(Religion.Text, Creator.Text, Description.Text, "", "", "", OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingReligions(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_Religion WHERE"
        Classification = "  Religion LIKE '%" & convertQuotes(Me.Religion.Text) & "%'"
