...
Public Class PHICTABLEMainForm
    Dim query1 As String = "SELECT PHICID as PHIC_ID, format(RangeFrom,3)as Range_From, format(RangeTo,3) as Range_To,  format(EEShare,3) as EE_Share,format(ERShare,3) as ER_Share, format(MonthlyPremium,3) as Monthly_Premium,Compute, Creator  from PHICTABLE "
    Dim query2 As String = " phicid"
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_PHICTABLE WHERE PHICTABLEID='" & Me.DataGridView1.Item(i, "PHICTABLEID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "PHICTABLEID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_PHICTABLE WHERE PHICTABLEID='" & Me.DataGridView1.Item(i, "PHICTABLEID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
...
#End Region
    ...
    Public Sub formatdatagrid()
        ...
        With Me.DataGridView1
            ...
            ' .Item(0, 1) = "ID"
            .Cols("PHIC_ID").TextAlign = TextAlignEnum.RightCenter
            ...
            .Cols("Monthly_Premium").TextAlign = TextAlignEnum.RightCenter
