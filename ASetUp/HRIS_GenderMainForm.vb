...
Public Class HRIS_GenderMainForm
    Dim query1 As String = "SELECT * from hris_Gender "
    Dim query2 As String = " Gender"
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim GenderID As Integer = reader.Item("GenderID")
                    Dim Gender As String = reader.Item("Gender")
                    Dim x As New HRIS_GenderRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(GenderID)
                        .GenderID = GenderID
                        .Text = "Currently modifying : " & Gender
...
#Region "Controls and Buttons"
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from hris_Gender WHERE GenderID='" & Me.DataGridView1.Item(i, "GenderID") & _
                           "'", 1)
        Catch ex As Exception
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "GenderID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from hris_Gender WHERE GenderID='" & Me.DataGridView1.Item(i, "GenderID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
...
#End Region
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingGenders(overallQuery)
    End Sub
    Public Sub loadingGenders(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        overallQuery = performSearchQuery(Gender.Text, Creator.Text, Description.Text, ChangesMade.Text, DateCreated.Text, LastUpdate.Text, OrderbyOf, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingGenders(overallQuery)
    End Sub
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from hris_Gender WHERE"
        Classification = "  Gender LIKE '%" & convertQuotes(Me.Gender.Text) & "%'"
        creator = " AND Creator LIKE '%" & convertQuotes(Me.Creator.Text) & "%' "
        description = " AND DESCRIPTION LIKE '%" & convertQuotes(Me.Description.Text) & "%'"
        changesmade = " AND ChangesMade LIKE '%" & convertQuotes(Me.ChangesMade.Text) & "%'"
        datecreated = " "
        lastupdate = " "
