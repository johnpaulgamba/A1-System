...
Public Class Sales_Orders_Solo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Sales_Orders_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSales_Orders_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sales_Orders_Solo = New Sales_Orders_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
