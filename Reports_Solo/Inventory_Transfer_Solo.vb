...
Public Class Inventory_Transfer_Solo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Inventory_Transfer_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BakeTechSoftware.Inventory_Transfer_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInventory_Transfer_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Inventory_Transfer_Solo = New Inventory_Transfer_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
