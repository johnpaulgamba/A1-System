...
Public Class Sales_Return_Solo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Sales_Return_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSales_Return_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sales_Return_Solo = New Sales_Return_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
