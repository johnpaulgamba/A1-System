...
Public Class Vat_Inclusive_Solo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Vat_Inclusive_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVat_Inclusive_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Vat_Inclusive_Solo = New Vat_Inclusive_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
