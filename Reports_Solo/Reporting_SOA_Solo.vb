...
Public Class Reporting_SOA_Solo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Reporting_SOA_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporting_SOA_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporting_SOA_Solo = New Reporting_SOA_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
