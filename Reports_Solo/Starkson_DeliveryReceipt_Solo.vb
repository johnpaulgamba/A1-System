...
Public Class Starkson_DeliveryReceipt_Solo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Starkson_DeliveryReceipt_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Starkson_DeliveryReceipt_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStarkson_DeliveryReceipt_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Starkson_DeliveryReceipt_Solo = New Starkson_DeliveryReceipt_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
