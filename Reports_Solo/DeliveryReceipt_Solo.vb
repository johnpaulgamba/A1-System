...
Public Class DeliveryReceipt_Solo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DeliveryReceipt_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.DeliveryReceipt_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeliveryReceipt_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeliveryReceipt_Solo = New DeliveryReceipt_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
