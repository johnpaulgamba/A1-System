...
Public Class Service_Report_Solo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Service_Report_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Service_Report_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedService_Report_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Service_Report_Solo = New Service_Report_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
