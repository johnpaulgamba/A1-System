...
Public Class Vat_Exclusive_Solo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "A1plus.Vat_Exclusive_Solo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVat_Exclusive_Solo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Vat_Exclusive_Solo = New Vat_Exclusive_Solo()
        rpt.Site = Me.Site
        Return rpt
    End Function
