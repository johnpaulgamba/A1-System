...
Public Class user_permission_modules_main
    ...
    Private Sub inputbutton1_click(ByVal sender As system.object, ByVal e As system.eventargs) Handles inputbutton1.click
        Dim i As String = " where groupname like '%" & convertquotes(Me.group.text) & _
            ...
            "%' and a.modulename like '%" & convertquotes(Me.modulename.text) & _
            "%' and a.modulebuttonname like '%" & convertquotes(Me.buttonname.text) & _
            "%' and a.classname like '%" & convertquotes(Me.classname.text) & _
            "%' "
        Dim isactive = ""
    ...
    Private Sub queryall(ByVal a As String)
        querystring = a
        loaddata("user_permission_module_gridmain", a, Me.c1flexgrid1)
    End Sub
    ...
    Private Sub addnewcommand_click(ByVal sender As system.object, ByVal e As c1.win.c1command.clickeventargs) Handles addnewcommand.click
        Dim x As New user_permission_modules_entry(0)
        With x
    ...
    Private Sub deleterecordcommand_click(ByVal sender As system.object, ByVal e As c1.win.c1command.clickeventargs) Handles deleterecordcommand.click
        Try
            ...
            If sagot = msgboxresult.yes Then
                saveeditdelete("delete from user_permission_modules where moduleid=" & Me.c1flexgrid1.rows(Me.c1flexgrid1.rowsel).item("moduleid"), "deleted")
                refreshform()
            End If
        Catch ex As exception
        End Try
    ...
    Public Sub refreshform()
        loaddata("user_permission_module_gridmain", Me.querystring, Me.c1flexgrid1)
    End Sub
    ...
    Private Sub editrecordcommand_click(ByVal sender As Object, ByVal e As c1.win.c1command.clickeventargs) Handles editrecordcommand.click
        Try
            Dim id As Integer = Me.c1flexgrid1.rows(Me.c1flexgrid1.rowsel).item("moduleid")
            Dim x As New user_permission_modules_entry(id)
            With x
