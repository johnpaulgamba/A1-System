...
Public Class ShippingAddressMainForm
    Sub New()

        ' this call is required by the designer.
        initializecomponent()
    End Sub
    Private Sub ShippingAddressmainform_load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        loaddata("admin_ShippingAddress_main", " where b.companyid='" & companyid & "'", Me.C1FlexGrid1)
    End Sub
    Private filter As String = ""
    Private Sub searchbutton_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchButton.Click
        Dim filterquery As String = " where a.shipAddress like '%" & convertQuotes(Me.ShippingAddress.Text) & _
        "%' and b.customername like '%" & convertQuotes(Me.customername.Text) & _
         "%' and b.datecreated like '%" & convertQuotes(Me.DateCreated.Text) & _
          "%' and b.companyid = '" & companyid & _
        "' and b.creator like '%" & convertQuotes(Me.Creator.Text) & "%' "
        Me.filter = filterquery
        loaddata("admin_ShippingAddress_main", filter, Me.c1flexgrid1)

    End Sub

    Private Sub addnew_click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles AddNew.Click
        Dim x As New ShippingAddressEntry(0)
        With x
    ...
    Private Sub editrecord_click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles EditRecord.Click
        Try
            Dim id As Integer = Me.C1FlexGrid1.Rows(Me.C1FlexGrid1.RowSel).Item("Shipid")
            Dim x As New ShippingAddressEntry(id)
            With x
                .startposition = formstartposition.centerscreen
                .showdialog()
            End With
