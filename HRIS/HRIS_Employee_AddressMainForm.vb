...
Imports System.IO
Public Class HRIS_Employee_AddressMainForm

    Dim query1 As String = " Select a.AddressID as AddressID, " & _
        " Concat('ADR ', a.AddressID) as Reference, " & _
        " (Case When isPermanent=1 AND isPresent=1 Then 'PRESENT/PERMANENT' ELSE (Case When isPermanent=1 Then 'PERMANENT'  ELSE (Case When isPresent=1 THEN 'PRESENT'  Else 'NONE' END) END ) END) as Type,  " & _
        " Concat('EMP ', b.EmployeeID) as EmployeeID,  " & _
        " Concat(LastName, ', ', FirstName, ' ', MiddleName) as Employee, " & _
        " CompleteAddress, " & _
        " Concat(LengthOfStay, ' ', MeasureOfStay) as LengthOfStay, " & _
        " b.Active, a.COntactNo," & _
        " a.DateCreated,  a.Creator " & _
        " From HRIS_Address a" & _
        " JOIN hris_employee b On a.EmployeeID=b.EmployeeID  " & _
        " WHERE a.EmployeeID=b.EmployeeID "
    Dim query2 As String = " CompleteAddress  "
    Dim QUERY3 As String = " GROUP BY  a.AddressID "
...
#Region "Controls and Commands"
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            Dim ID As Integer = Me.DataGridView1.Rows(i).Item("AddressID")
            Dim x As New HistoryUpdate
            With x
                .loaddata("HRIS_Address", "AddressID", id)
...
#End Region
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If SSSNo.Text = "" Then s3 = "" Else s3 = " and a.completeaddress like '%" & SSSNo.Text & "%' "
        Dim filtersearchquery As String = s1 & s2 & s4 & s3 & returnActiveInactive(ActiveYes.Checked, ActiveNo.Checked, ActiveBoth.Checked)
    ...
    Private Sub EditCommand_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles EditCommand.Click
        Try
            ...
            Dim i As Integer = Me.DataGridView1.Rows(Me.DataGridView1.RowSel).Item("AddressId")
            Dim x As New HRIS_EmployeeRegistration_Address(i)
            With x
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
