...
Imports System.IO
Public Class hris_dependentsMainForm

    Dim query1 As String = " Select a.DependentID as DependentID, " & _
        " Concat('ADR ', a.DependentID) as Reference, " & _
        " Concat('EMP ', b.EmployeeNo) as EmployeeNo,  " & _
        " Concat(LastName, ', ', FirstName, ' ', MiddleName) as Employee, " & _
        " DependentName, Relationship,  " & _
        " a.Gender,   " & _
        " date_format(a.BirthDate, '%m/%d/%Y') as 'BirthDate',floor(datediff(now(), a.birthdate)/365) as Age , " & _
        " b.Active, isEmergencyContact as Emer, " & _
        " a.Creator " & _
        " From Hris_dependents a" & _
        " JOIN hris_employee b On a.EmployeeID=b.EmployeeID  " & _
        " WHERE a.EmployeeID=b.EmployeeID    "
    Dim query2 As String = " DependentName  "
    Dim QUERY3 As String = " GROUP BY  a.DependentID "
...
#Region "Controls and Commands"
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            Dim ID As Integer = Me.DataGridView1.Rows(i).Item("DependentID")
            Dim x As New HistoryUpdate
            With x
                ' .loaddata("hris_dependents", "DependentID", ID)
...
#End Region
    ...
    Public Sub formatdatagrid()
        With Me.DataGridView1
            ...
            .Cols("DependentID").Visible = False
            ColumnVisible()
        End With
    End Sub
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If SSSNo.Text = "" Then s3 = "" Else s3 = " and a.dependentname like '%" & SSSNo.Text & "%' "
    ...
    Private Sub EditCommand_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles EditCommand.Click
        Try
            ...
            Dim i As Integer = Me.DataGridView1.Rows(Me.DataGridView1.RowSel).Item("DependentID")
            Dim x As New HRIS_EmployeeRegistration_Dependent(i)
            With x
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
