...
Imports System.IO
Public Class hris_educationalattainmentsMainForm

    Dim query1 As String = " Select a.EducationID as EducationID, " & _
        " Concat('EDA ', a.EducationID) as Reference, " & _
        " Concat('EMP ', b.EmployeeID) as EmployeeID,  " & _
        " Concat(LastName, ', ', FirstName, ' ', MiddleName) as Employee, " & _
        " NameOfSchool, Concat(Period_From, ' - ', Period_To) as Period, Attainment, " & _
        " b.Active,   " & _
        " a.DateCreated, a.LastUpdate, a.CreatorNTUser " & _
        " From Hris_educationalattainment a" & _
        " JOIN hris_employee b On a.EmployeeID=b.EmployeeID  " & _
        " WHERE a.EmployeeID=b.EmployeeID   "
    Dim query2 As String = " NameOfSchool  "
    Dim QUERY3 As String = " GROUP BY  a.EducationID "
...
#Region "Controls and Commands"
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            Dim ID As Integer = Me.DataGridView1.Rows(i).Item("EducationID")
            Dim x As New HistoryUpdate
            With x
                .loaddata("hris_educationalattainment", "EducationID", ID)
...
#End Region
    ...
    Public Sub formatdatagrid()
        With Me.DataGridView1
            ...
            .Cols("EducationID").Visible = False
            ColumnVisible()
        End With
    End Sub
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If SSSNo.Text = "" Then s3 = "" Else s3 = " and a.nameofschool like '%" & SSSNo.Text & "%' "
    ...
    Private Sub EditCommand_Click(ByVal sender As System.Object, ByVal e As C1.Win.C1Command.ClickEventArgs) Handles EditCommand.Click
        Try
            ...
            Dim i As Integer = Me.DataGridView1.Rows(Me.DataGridView1.RowSel).Item("EducationID")
            Dim x As New HRIS_EmployeeRegistration_Education(i)
            With x
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
