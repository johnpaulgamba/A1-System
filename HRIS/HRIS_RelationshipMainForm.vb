...
Public Class HRIS_RelationshipMainForm
    Dim query1 As String = "SELECT * from HRIS_Relationship "
    Dim query2 As String = " Relationship"
...
#Region "Controls and Buttons"
    Private Sub Register_Click() Handles SOAddMenu.Click
        Dim x As New HRIS_RelationshipRegistration
        With x
    ...
    Private Sub EditRecord_Click() Handles SOEditMenu.Click
        Try
            ...
            readingAllInfo("SELECT * from HRIS_Relationship WHERE RelationshipID='" & Me.DataGridView1.Item(i, "RelationshipID") & _
                           "'", 1)
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            With x
                ...
                .Text = "Item history of " & Me.DataGridView1.Item(i, "RelationshipID")
                .StartPosition = FormStartPosition.CenterParent
                .ShowDialog()
            End With
        Catch ex As Exception
    ...
    Private Sub DeleteRecord_Click() Handles SODeleteMenu.Click
        Try
            ...
            If answer = MsgBoxResult.Yes Then
                Dim i As Integer = Me.DataGridView1.RowSel
                saveEditDelete("DELETE from HRIS_Relationship WHERE RelationshipID='" & Me.DataGridView1.Item(i, "RelationshipID") & _
                         "'", "deleted.")
                Refresh_Click()
            End If
        Catch ex As Exception
    ...
    Private Sub Refresh_Click() Handles SoRefresh.Click, ReloadAllRecords.Click
        loadingHRIS_Relationship(overallQuery)
    End Sub
...
#End Region
        ...
        Try
            ...
            If b = 1 Then
                If reader.Read = True Then
                    Dim RelationshipID As Integer = reader.Item("RelationshipID")
                    Dim Relationship As String = reader.Item("Relationship")
                    Dim x As New HRIS_RelationshipRegistration
                    With x
                        .QuerytoString = overallQuery
                        .toSave = False
                        .EditLoad(RelationshipID)
                        .RelationshipID = RelationshipID
                        .Text = "Currently modifying : " & Relationship
                        .StartPosition = FormStartPosition.CenterParent
                        .ShowDialog()
                    End With
                    con.Close()
    ...
    Public Sub LoadingForm() Handles SOShowAll.Click
        ...
        loadingHRIS_Relationship(overallQuery)
    End Sub
    Public Sub loadingHRIS_Relationship(ByVal sql As String)
        Try
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If Me.OrderBY.Text.ToLower = "classification" Then Orderbyof = "Relationship" Else Orderbyof = Trim(Me.OrderBY.Text.Replace(" ", ""))
        overallQuery = performSearchQuery(Relationship.Text, Creator.Text, Description.Text, "", DateCreated.Text, LastUpdate.Text, Orderbyof, sortarrangement, returnActiveInactive(RecordsActive.Checked, RecordsInactive.Checked, RecordsBoth.Checked))
        loadingHRIS_Relationship(overallQuery)
    End Sub
    ...
    Private Function performSearchQuery(ByVal Classification As String, ByVal creator As String, ByVal description As String, _
        ...
        Dim query1 As String = "SELECT * from HRIS_Relationship WHERE"
        Classification = "  Relationship LIKE '%" & convertQuotes(Me.Relationship.Text) & "%'"
