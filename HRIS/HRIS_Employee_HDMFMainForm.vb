...
Public Class Hris_Employee_HDMFMainForm
    Dim query1 As String = "Select a.EmployeeID,a.EmployeeNo, concat(a.lastname,', ',a.FirstName,' ',a.MiddleName) as Employee, a.HDMF as Pagibig_No, format(a.basicpaymonth,2) as Basic_Salary," & _
" (case when a.hdmfee <>0 then a.hdmfee else (case when b.compute = 1 then format(b.salarycredit*b.hdmfee,2) else b.hdmfee end) End) as EE_Share, " & _
" (case when b.compute = 1 then format(b.salarycredit*b.hdmfer,2) else b.hdmfer end) as ER_Share " & _
" from hris_employee a join hdmftable b where a.BasicPayMonth between b.rangefrom and b.rangeto and a.active=1 "
    Dim query2 As String = " HDMF"
...
#Region "Controls and Buttons"
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            Dim x As New HRIS_Employee_HDMF_Registration(Me.DataGridView1.Item(i, "EmployeeID"))
            With x
                .StartPosition = FormStartPosition.CenterScreen
                .ShowDialog()
...
#End Region
   ...
   Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If SSSNo.Text = "" Then s3 = "" Else s3 = " and a.hdmf like '%" & SSSNo.Text & "%' "
    ...
    Private Sub Hris_Employee_HDMFMainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
