...
Public Class Hris_Employee_SSSMainForm
    Dim query1 As String = "Select a.EmployeeID,a.EmployeeNo, concat(a.lastname,', ',a.FirstName,' ',a.MiddleName) as Employee, a.SSS as SSS_No, format(a.basicpaymonth,2) " & _
        " as Basic_Salary, format(b.ee,2) as EE_Share, format(b.ec,2) as EC_Share, format(b.er,2) as ER_Share, format(b.ERTotal,2) as ER_Total, " & _
        " format(b.Total,2) as Total,a.Creator from hris_employee a join ssstable b where a.BasicPayMonth between b.rangefrom and b.rangeto and a.active=1  "
    Dim query2 As String = " SSS"
...
#Region "Controls and Buttons"
    ...
    Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            Dim x As New HRIS_Employee_SSS_Registration(Me.DataGridView1.Item(i, "EmployeeID"))
            With x
                .StartPosition = FormStartPosition.CenterScreen
                .ShowDialog()
...
#End Region
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If SSSNo.Text = "" Then s3 = "" Else s3 = " and a.sss like '%" & SSSNo.Text & "%' "
    ...
    Private Sub Hris_Employee_SSSMainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
