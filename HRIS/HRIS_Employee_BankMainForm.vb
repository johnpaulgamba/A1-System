...
Public Class Hris_Employee_BankMainForm
    Dim query1 As String = "SELECT employeeid, employeeno, concat(LastName,', ', FirstName,' ',MiddleName) as Employee, PaymentMethod, replace(bankaccountno,'-','') as ATM_AccountNo, Creator from Hris_Employee where employeeid<>0  "
    Dim query2 As String = " BankAccountNo"
...
#Region "Controls and Buttons"
  Private Sub ViewItemHistory_Click() Handles SOViewRecord.Click
        Try
            ...
            Dim x As New HRIS_Employee_Bank_Registration(Me.DataGridView1.Item(i, "EmployeeID"))
            With x
...
#End Region
    ...
    Private Sub SearchRecords_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SearchRecords.Click
        ...
        If CompanyName.Text = "" Then s1 = "" Else s1 = " and companyid = '" & CompanyName.SelectedValue & "' "
        If Department.Text = "" Then s2 = "" Else s2 = " and departmentid = '" & Department.SelectedValue & "' "
        If EmployeeName.Text = "" Then s4 = "" Else s4 = " and employeeid='" & EmployeeName.SelectedValue & "' "
        If SSSNo.Text = "" Then s3 = "" Else s3 = " and bankaccountno like '%" & SSSNo.Text & "%' "
    ...
    Private Sub ClearFields_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClearFields.Click
        FunctionClass.ClearPanel(BasicSearchOption)
    End Sub
    ...
    Private Sub Hris_Employee_BankMainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
